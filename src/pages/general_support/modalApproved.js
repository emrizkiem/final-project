                ...
                <Tr>
                  ...
                  <Td paddingStart="1px">
                    <Box fontSize="13px" justifyContent="left" display="flex" alignItems="left">
                      <Box justifyContent="center" display="flex" alignItems="center" height="30px" boxSizing="unset" borderRadius="5px" width="80px" borderWidth="1px" px="10px" bgColor="#7DDFC3" >
                        Disetujui
                      </Box>
                    </Box>
                  </Td>
